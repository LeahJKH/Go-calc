...
func (MyTheme) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	...
	case theme.ColorNameButton:
		return color.NRGBA{R: 0x70, G: 0x6f, B: 0x6f, A: 0x0}
	...
	case theme.ColorNameFocus:
		return color.NRGBA{R: 0xd3, G: 0x84, B: 0xe0, A: 0x7f}
	case theme.ColorNameForeground:
		return color.NRGBA{R: 0xf8, G: 0xf7, B: 0xf7, A: 0xff}
	case theme.ColorNameHover:
		return color.NRGBA{R: 0x98, G: 0x95, B: 0x95, A: 0xf}
